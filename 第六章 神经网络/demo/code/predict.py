...
inputfile = 'D:/教育/python_machine_learning/第六章 神经网络/test/tmp/new_reg_data_GM11.xls'  # 灰色预测后保存的路径
...
outputfile = 'D:/教育/python_machine_learning/第六章 神经网络/test/tmp/new_reg_data_GM11_revenue.xls'  # SVR预测后保存的结果
